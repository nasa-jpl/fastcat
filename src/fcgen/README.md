...
To install cogapp on Ubuntu, use the distro package. If `universe` is not enabled yet, add it first:
...
```bash
cogapp -d -D yaml_file=/home/dev/src/fastcat/fastcat_device/tools/cog_workspace/input/el2124_slave.yaml @cog_in.txt
```
