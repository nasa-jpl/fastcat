...
bool ParseValCheckRange(const YAML::Node& node, const std::string& field, double& val,
                        double lower, double upper);

bool ParseValCheckRange(const YAML::Node& node, const std::string& field, float& val,
                        float lower, float upper);

bool ParseValCheckRange(const YAML::Node& node, const std::string& field, int32_t& val,
                        int32_t lower, int32_t upper);

bool ParseValCheckRange(const YAML::Node& node, const std::string& field, uint32_t& val,
                        uint32_t lower, uint32_t upper);

bool ParseValCheckRange(const YAML::Node& node, const std::string& field, int16_t& val,
                        int16_t lower, int16_t upper);

bool ParseValCheckRange(const YAML::Node& node, const std::string& field, uint16_t& val,
                        int16_t lower, int16_t upper);

bool ParseValCheckRange(const YAML::Node& node, const std::string& field, int8_t& val,
                        int8_t lower, int8_t upper);

bool ParseValCheckRange(const YAML::Node& node, const std::string& field, uint8_t& val,
...
bool ParseOptValCheckRange(const YAML::Node& node, const std::string& field, double& val,
                           double lower, double upper);
